...
public:
    ...
    Status SetEnvironmentOverride(EnvironmentOverride overrride, Light* light);
    Status GetEnvironmentOverride(EnvironmentOverride overrride, Light** out_light);
...
public:
    ...
    Status SetEnvironmentOverride(EnvironmentOverride overrride, Image* image);
    Status GetEnvironmentOverride(EnvironmentOverride overrride, Image** out_image);
private:
