...
Status Scene::GetEnvironmentOverride(EnvironmentOverride overrride, Light** out_light) {
    rpr_light temp = nullptr;
    RPR_CPPWRAPER_CALL_PREFIX
    rprSceneGetEnvironmentOverride(GetRprObject(this), overrride, &temp)
    RPR_CPPWRAPER_GET_CALL_SUFFIX
    *out_light = GetContextObjectFromRprApiObject<Light>(temp);
    return RPR_SUCCESS;
}

Status Scene::SetEnvironmentOverride(EnvironmentOverride overrride, Light* light) {
    RPR_CPPWRAPER_CALL_PREFIX
    rprSceneSetEnvironmentOverride(GetRprObject(this), overrride, GetRprObject(light))
    RPR_CPPWRAPER_CALL_SUFFIX
}
...
Status EnvironmentLight::SetEnvironmentOverride(EnvironmentOverride overrride, Image* in_image) {
    RPR_CPPWRAPER_CALL_PREFIX
    rprEnvironmentLightSetEnvironmentOverride(GetRprObject(this), overrride, GetRprObject(in_image))
    RPR_CPPWRAPER_CALL_SUFFIX
}

Status EnvironmentLight::GetEnvironmentOverride(EnvironmentOverride overrride, Image** out_image) {
    rpr_image temp = nullptr;
    RPR_CPPWRAPER_CALL_PREFIX
    rprEnvironmentLightGetEnvironmentOverride(GetRprObject(this), overrride, &temp)
    RPR_CPPWRAPER_GET_CALL_SUFFIX
    *out_image = GetContextObjectFromRprApiObject<Image>(temp);
    return RPR_SUCCESS;
}
